...
execute store result score @s Primary.Type run data get entity @s Inventory[{Slot:0b}].tag.Stats.Item.Type
execute store result score @s Secondary.Type run data get entity @s Inventory[{Slot:-106b}].tag.Stats.Item.Type
#--------------------------Armor---------------------------#
...
execute unless score @s Primary.Type = @s S.Primary.Type run function hh:stats/player/get/weapons/primary
execute unless score @s Secondary.Type = @s S.Secondary.Type run function hh:stats/player/get/weapons/secondary
#----------------------------------------------------------#